-- Standalone SQL: create offline tables in public schema
...
create index if not exists idx_offline_transactions_sync_status
  on public.offline_transactions (sync_status);
